        ...
        <div className="max-w-4xl mx-auto">
          <Card padding="lg">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I&apos;m passionate about helping aspiring developers and tech professionals grow in
                their careers. Through personalized mentorship, I provide guidance on technical
              ...
              <Card key={index} padding="lg">
                <div className="w-12 h-12 bg-foreground rounded-xl flex items-center justify-center mb-4">
                  <Image
                    ...
                    width={24}
                    height={24}
                    className="w-6 h-6 text-background invert dark:invert-0"
                  />
                </div>
