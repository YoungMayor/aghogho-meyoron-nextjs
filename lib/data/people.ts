const cloudinaryImage = (filename: string) =>
  `https://res.cloudinary.com/meyoron-aghogho/image/upload/people/${filename}`;

export const people = {
  tovyss: {
    name: 'Tovia Amadi',
    titles: ['Digital Marketer | Product Manager'],
    avatar_url: cloudinaryImage('Tovia-Amadi_rml20q.png'),
    biography:
  ...
  acetech: {
    ...
    avatar_url: cloudinaryImage('Adekunle-Adedoyin_qv8rtk.jpg'),
    biography: '',
    profile_link: null,
  },
  beejay: {
    ...
    avatar_url: cloudinaryImage('Benjamin-Onuoha_f5wjgh.jpg'),
    biography: '',
    profile_link: null,
  },
  biodun: {
    ...
    avatar_url: cloudinaryImage('Biodun-Bamigboye_mipsga.jpg'),
    biography: '',
    profile_link: null,
  },
  busta: {
    ...
    avatar_url: cloudinaryImage('Olaifa-Boluwatife_vggtzb.jpg'),
  ...
  chuba: {
    ...
    avatar_url: cloudinaryImage('Chuba-Samuel_pb7hss.jpg'),
  ...
  iammastercraft: {
    ...
    avatar_url: cloudinaryImage('Boluwaji-Akinsefunmi_fnjtch.jpg'),
  ...
  iyiola: {
    ...
    avatar_url: cloudinaryImage('Mohammed-Adekunle_hdelxh.jpg'),
    biography:
  ...
  laurence702: {
    ...
    avatar_url: cloudinaryImage('default_msqrmt.png'),
    biography:
  ...
  nazaa: {
    ...
    avatar_url: cloudinaryImage('Chinaza-Obiekwe_my83n9.jpg'),
  ...
  sudoaj: {
    ...
    avatar_url: cloudinaryImage('Abdusalam-Ajayi_kk6duy.jpg'),
    biography: '',
