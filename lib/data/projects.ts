...
export const projects: Project[] = [
  ...
  },
  {
    ...
    "description": "DevComm is a community for developers to connect and features an hub, news, article list, job postings, and private chatting. I built DevComm using the Laravel framework.",
    "features": [
  ...
  },
  {
    "slug": "booklib",
    "name": "BookLib",
    "description": "BookLib is a book library management system API that allows schools to keep track of their books and students' book borrowing activity. The system helps schools manage their book records and track which books are in students' possession.",
    "features": [
  ...
  },
  {
    "slug": "ijokes",
    "name": "iJokes",
    "description": "iJokes is a frontend API bridge application that fetches and displays jokes from a 3rd party open-source API for users. The application also includes a Telegram bot for more user-friendly interaction.",
    "features": [
      "API consumption",
      "Telegram Bot",
      "Interactive UIX"
  ...
  },
  {
    "slug": "expenman",
    "name": "ExpenMan",
    "description": "Expense Manager is a financial software that helps users track their income and expenses by recording them in multiple accounts. This tool allows users to easily keep track of their financial state and make informed decisions about their spending and saving.",
    "features": [
  ...
  },
  {
    "slug": "eytan",
    "name": "Eytan",
    "description": "Eytan is a hospital staff management system developed for tracking patients' hospital records and managing staff tasks. Please note that information about this project is protected by a non-disclosure agreement (NDA) from my previous employer.",
    "features": [
      "Staff Management",
      "Stock Management",
      "Admin Console",
  ...
  },
  {
    "slug": "joblinkup",
    "name": "JobLinkup",
    "description": "JobLinkup is a job agency application that connects job seekers with employers by scraping jobs daily from verified sources and helping users map and find their desired positions. This platform was designed to be user-friendly and effective in connecting job seekers and employers.",
    "features": [
  ...
  },
  {
    "slug": "talkspiration",
    "name": "Talkspiration",
    "description": "A multi-user blog platform that allows writers to connect and share their articles, blogs, and write-ups with the public. This platform was designed to be user-friendly and effective in connecting writers and providing a platform for them to share their work with a wider audience.",
    "features": [
  ...
  },
  {
    "slug": "contentforge",
    "name": "ContentForge",
    "description": "ContentForge isn't just another tool; it's your creative partner. We focus on versatility, quality, and user-friendly design to elevate your content.",
    "features": [
      "Article Generator ",
  ...
  },
  {
    "slug": "quizwise",
    "name": "QuizWise",
    "description": "The smart quiz platform built for thinkers, tinkerers, and trailblazers in tech. Every question is generated in real-time using Google’s Gemini AI, so no two quiz sessions are ever quite the same.",
    "features": [
      "Brainy",
      "Fast-paced",
      "AI-powered"
  ...
  },
  {
    "slug": "fun-arcade",
    "name": "Fun Arcade",
    "description": "Rediscover timeless classics and new challenges. Fun, simple, and ready to play anytime, anywhere.",
    "features": [
      "Timeless classics",
      "New challenges",
      "Fun",
  ...
  },
  {
    "slug": "resumeready",
    "name": "ResumeReady",
    "description": "Build professional, modern resumes in minutes. Our intuitive editor and customizable templates make it easy to stand out and land your dream job.",
    "features": [
      "Intuitive editor",
  ...
  },
  {
    "slug": "shellbase",
    "name": "ShellBase",
    "description": "ShellBase is an interactive command-line cheat sheet built using NextJS, designed to streamline your workflow. Unlike static cheat sheets, ShellBase offers dynamic search and filtering, enabling quick access to the commands you need. Boost your productivity and master the command line with ShellBase.",
    "features": [
      "Interactive Command Search",
      "Dynamic Filtering",
      "NextJS Powered Performance"
    ],
    "technologies": [
      {
        "name": "NextJS",
  ...
  },
  {
    "slug": "paylighter",
    "name": "PayLighter",
    "description": "A fintech application that enables unrestricted and decentralized fund payments. I was responsible for the development and maintenance of this platform, utilizing my skills in backend engineering and web development. Please note that information about this project is protected by a non-disclosure agreement (NDA).",
    "features": [
      "Payment management",
      "User wallets",
      "Fund transfer",
  ...
  },
  {
    "slug": "pidifier",
    "name": "Pidifier",
    "description": "Pidifier is a free SAAS which provides developers with an API for freely converting web pages to PDFs. It was developed mainly using NodeJS on the server and NuxtJS for the SAAS about page",
    "features": [
      "Opensource API",
  ...
  },
  {
    "slug": "glover",
    "name": "Glover",
    "description": "The Power of Digital service at your fingertips Giftcards, Crypto, Refill, Airtime2Cash etc. with effortless payments in a secured environment.",
    "features": [
      "Giftcards",
      "Crypto",
      "Refill",
  ...
  },
  {
    "slug": "learnflow-ai",
    "name": "LearnFlow AI",
    "description": "LearnFlow AI creates personalized courses on any topic, tailored to your learning style. Just describe what you want to learn, and let our AI do the rest.",
    "features": [
  ...
  },
  {
    ...
    "description": "Experience the thrill of a classic game show with 'Who Wants to Be a Millionaire,' powered by MayR Labs' adaptive AI. This interactive experience provides a realistic and engaging platform to test your knowledge. Compete against the AI, climb the money ladder, and see if you have what it takes to win!",
    "features": [
