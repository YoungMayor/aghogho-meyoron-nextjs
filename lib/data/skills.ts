...
/**
 * Skills and expertise of Aghogho Meyoron
...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    description:
      'Mastery of version control systems, particularly Git, for collaborative development. Experienced in branching strategies, code reviews, and conflict resolution.',
    type: 'soft',
    technologies: [],
    show: true,
    priority: 0,
